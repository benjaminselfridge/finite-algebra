...
-- this function.
renaming :: (Eq a, Ord b) => [(a, b)] -> Group a -> GroupHomomorphism a b
...
-- TODO: Elaborate documentation to explain the generativity result.
...
-- | Get the homomorphism generated by a lookup table mapping elements of one
-- group to another.
